	      	...
	      	<div class="modal-body">
	      		...
	      		<div class="form-group">
				    ...
				    <div class="input-group mb-3">
					  ...
					  <input type="text" class="form-control" placeholder="Movie example" aria-label="Category example" aria-describedby="basic-addon1"  name="title" required="">
					</div>
				 </div>
				 ...
				 <div class="form-group">
				    ...
				    <div class="input-group mb-3">
					  ...
					  <textarea class="form-control" rows="5" placeholder="description of the Movie" name="description"></textarea>
					</div>
				 </div>
				...
				<div class="form-group">
				    ...
				    <div class="input-group mb-3">
					  ...
					  <input type="number" name="minutes" placeholder="132" required="">
					</div>
				 </div>
				 ...
				 <div class="form-group">
				    ...
				    <div class="input-group mb-3">
					  ...
					  <input type="number" name="year" placeholder="2000" required="">
					</div>
				 </div>
				 ...
				 <div class="form-group">
				    ...
				    <div class="input-group mb-3">
					  ...
					  <input type="file" class="form-control" placeholder="Category example" aria-label="Category example" aria-describedby="basic-addon1"  name="cover_file" required="">
					</div>
				 </div>
				 ...
				 <div class="form-group">
				    ...
				    <div class="input-group mb-3">
					  ...
					  <input type="text" class="form-control" placeholder="youtube.com" aria-label="Category example" aria-describedby="basic-addon1"  name="trailer" required="">
					</div>
				 </div>
